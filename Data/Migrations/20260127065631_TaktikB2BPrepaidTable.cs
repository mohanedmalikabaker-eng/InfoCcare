...
{
    /// <inheritdoc />
    public partial class TaktikB2BPrepaidTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TaktikB2BPrepaid",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaktikB2BPrepaid", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaktikB2BPrepaid_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaktikB2BPrepaid_CreatedById",
                table: "TaktikB2BPrepaid",
                column: "CreatedById");
        }
